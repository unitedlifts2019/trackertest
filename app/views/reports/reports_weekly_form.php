<h1>Generate a Period Callout Report</h1>

<form id="genForm" action="<?=app("url")?>/exec/reports/weekly_generate" method="POST" target="_blank">
    ...
    <label>&nbsp;</label><button id='formbutton'>Generate Period Report</button>  
</form>
